...
if __name__ == '__main__':
    ...
    fp_group.add_argument('--input', '-i', help='the input folder/file, or a text file for paths', type=str,
                          default='in')
    fp_group.add_argument('--in_format', '-if', type=str, help='the input format', default='xxx')
    fp_group.add_argument('--output', '-o', help='the output folder/file', type=str, default='out')
